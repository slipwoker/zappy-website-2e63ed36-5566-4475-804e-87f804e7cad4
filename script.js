    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "עולם הפשע בליגה הגבוהה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '2e63ed36-5566-4475-804e-87f804e7cad4',
                    name: data.name || '',
                    email: data.email || '',
